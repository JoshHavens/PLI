 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "pli.com", ownerName = "pli.com", packagePath=""))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyBjz6K3nnOowRDpmnYEtuCJTsSbBAnGdoE";
